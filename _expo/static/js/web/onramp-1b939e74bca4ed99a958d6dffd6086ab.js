...
__d(function(g,_r,_i,a,m,e,_d){"use strict";Object.defineProperty(e,'__esModule',{value:!0}),Object.defineProperty(e,"W3mWhatIsABuyView",{enumerable:!0,get:function(){return o}});var t=_r(_d[0]),r=_r(_d[1]),i=_r(_d[2]);_r(_d[3]),_r(_d[4]),_r(_d[5]),_r(_d[6]),_r(_d[7]);var n=this&&this.__decorate||function(t,r,i,n){var o,u=arguments.length,l=u<3?r:null===n?n=Object.getOwnPropertyDescriptor(r,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(t,r,i,n);else for(var c=t.length-1;c>=0;c--)(o=t[c])&&(l=(u<3?o(l):u>3?o(r,i,l):o(r,i))||l);return u>3&&l&&Object.defineProperty(r,i,l),l};let o=class extends t.LitElement{render(){return t.html`
    ...
    `}};o=n([(0,i.customElement)('w3m-what-is-a-buy-view')],o)},6494,[5098,4205,5095,5976,5944,5952,5945,6141]);
__d(function(g,_r,_i,a,m,e,_d){"use strict";Object.defineProperty(e,'__esModule',{value:!0}),Object.defineProperty(e,"W3mFundWalletView",{enumerable:!0,get:function(){return n}});var t=_r(_d[0]),i=_r(_d[1]),r=_r(_d[2]),o=_r(_d[3]);_r(_d[4]),_r(_d[5]),_r(_d[6]);var s=this&&this.__decorate||function(t,i,r,o){var s,n=arguments.length,l=n<3?i:null===o?o=Object.getOwnPropertyDescriptor(i,r):o;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)l=Reflect.decorate(t,i,r,o);else for(var c=t.length-1;c>=0;c--)(s=t[c])&&(l=(n<3?s(l):n>3?s(i,r,l):s(i,r))||l);return n>3&&l&&Object.defineProperty(i,r,l),l};let n=class extends t.LitElement{constructor(){super(),this.unsubscribe=[],this.activeCaipNetwork=r.ChainController.state.activeCaipNetwork,this.features=r.OptionsController.state.features,this.remoteFeatures=r.OptionsController.state.remoteFeatures,this.exchangesLoading=r.ExchangeController.state.isLoading,this.exchanges=r.ExchangeController.state.exchanges,this.unsubscribe.push(r.OptionsController.subscribeKey('features',t=>this.features=t),r.OptionsController.subscribeKey('remoteFeatures',t=>this.remoteFeatures=t),r.ChainController.subscribeKey('activeCaipNetwork',t=>{this.activeCaipNetwork=t,this.setDefaultPaymentAsset()}),r.ExchangeController.subscribeKey('isLoading',t=>this.exchangesLoading=t),r.ExchangeController.subscribeKey('exchanges',t=>this.exchanges=t))}disconnectedCallback(){this.unsubscribe.forEach(t=>t())}async firstUpdated(){r.ExchangeController.isPayWithExchangeSupported()&&(await this.setDefaultPaymentAsset(),await r.ExchangeController.fetchExchanges())}render(){return t.html`
      <wui-flex flexDirection="column" .padding=${['1','3','3','3']} gap="2">
        ${this.onrampTemplate()} ${this.receiveTemplate()} ${this.depositFromExchangeTemplate()}
      </wui-flex>
    `}async setDefaultPaymentAsset(){if(!this.activeCaipNetwork)return;const t=await r.ExchangeController.getAssetsForNetwork(this.activeCaipNetwork.caipNetworkId),i=t.find(t=>'USDC'===t.metadata.symbol)||t[0];i&&r.ExchangeController.setPaymentAsset(i)}onrampTemplate(){if(!this.activeCaipNetwork)return null;const i=this.remoteFeatures?.onramp,o=r.ConstantsUtil.ONRAMP_SUPPORTED_CHAIN_NAMESPACES.includes(this.activeCaipNetwork.chainNamespace);return i&&o?t.html`
      <wui-list-item
    ...
    `:null}depositFromExchangeTemplate(){if(!this.activeCaipNetwork)return null;return r.ExchangeController.isPayWithExchangeSupported()?t.html`
      <wui-list-item
    ...
    `:null}receiveTemplate(){return Boolean(this.features?.receive)?t.html`
      <wui-list-item
    ...
    `:null}onBuyCrypto(){r.RouterController.push('OnRampProviders')}onReceive(){r.RouterController.push('WalletReceive')}onDepositFromExchange(){r.RouterController.push('PayWithExchange',{redirectView:r.RouterController.state.data?.redirectView})}};s([(0,i.state)()],n.prototype,"activeCaipNetwork",void 0),s([(0,i.state)()],n.prototype,"features",void 0),s([(0,i.state)()],n.prototype,"remoteFeatures",void 0),s([(0,i.state)()],n.prototype,"exchangesLoading",void 0),s([(0,i.state)()],n.prototype,"exchanges",void 0),n=s([(0,o.customElement)('w3m-fund-wallet-view')],n)},6495,[5098,5874,4205,5095,5944,5965,5945]);
